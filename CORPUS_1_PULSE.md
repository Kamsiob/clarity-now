...
Section 11.1 of `CLARITY_LOGIC_ENGINE.md` gives the sizing targets, and phase 9 has brought every hot family in this volume inside them. persistence, quietDay, concentration, accumulation and rebalance each carry 63 to 71 statements per stage against a target band of 60 to 100. The six families below the hot line are the size 11.1 asks of them and are deliberately not grown: throughput, spread, switching, burst, queueDrain and freshStart together fire under 110 times a year across eleven simulated lives, where rebalance alone fires 101.
