...
internal object ValidateFixture {
    ...
    fun history(
        ...
        weekStartKeySeries: List<String> = emptyList(),
        weeksSinceBetterWeek: Int? = null,
        ...
        weekStartKeySeries = weekStartKeySeries,
